...
from .config import DATABASE_NAME, DATABASE_HOST, DATABASE_PASSWORD, DATABASE_PORT, DATABASE_USER
...
SECRET_KEY = 'django-insecure-+uj0me=#xn!hy^0qiu8g6##ye*l#urx)v4d-ir^&r^nzvir7&0'
